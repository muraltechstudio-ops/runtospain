    ...
    <>
      ...
      <main className="min-h-screen pt-32 pb-20 px-4 bg-brand-dark flex items-center relative overflow-hidden">
        ...
        <div className="max-w-xl mx-auto w-full text-center relative z-10">
          ...
          >
            <h1 className="font-display text-7xl md:text-8xl text-white mb-4 leading-none tracking-tighter">{t('confirm.title')}</h1>
            <p className="text-gray-400 text-lg mb-10 max-w-md mx-auto">{t('confirm.thanks').replace('{name}', nom)}</p>
          </motion.div>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-gray-500 text-[10px] uppercase font-bold tracking-widest">{t('confirm.date')}</div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-gray-500 text-[10px] uppercase font-bold tracking-widest">{t('confirm.destinations')}</div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-gray-500 text-[10px] uppercase font-bold tracking-widest">{t('confirm.seats')}</div>
                    <div className="text-white font-bold">{places} {parseInt(places) > 1 ? t('sl.seats') : t('sl.seat')}</div>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-white/5 rounded-lg border border-white/5"><Clock size={16} className="text-brand-red" /></div>
                  <div>
                    <div className="text-gray-500 text-[10px] uppercase font-bold tracking-widest">{t('confirm.return')}</div>
          ...
          >
            ...
            <div className="space-y-6">
              {[
                { icon: <Mail size={18} />, title: t('confirm.step.email'), text: t('confirm.step.emailDesc').replace('{email}', email) },
                { icon: <MessageSquare size={18} />, title: t('confirm.step.whatsapp'), text: t('confirm.step.whatsappDesc') },
                { icon: <Clock size={18} />, title: t('confirm.step.meetup'), text: t('confirm.step.meetupDesc') },
              ].map((step, i) => (
          ...
          >
            ...
            <a href="https://wa.me/33636226987"
              ...
              <MessageSquare size={20} /> {t('confirm.question')}
            </a>
          </motion.div>
        </div>
      </main>
