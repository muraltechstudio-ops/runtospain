...
export default function PourquoiJonquera() {
  ...
  const produits = [
    { emoji: '🍷', categorie: t('pjk.compare.alcools'), exemple: 'Bouteille de Rioja', prixFR: '12-18€', prixES: '4-7€', economie: '-60%' },
    { emoji: '🚬', categorie: t('pjk.compare.tabac'), exemple: 'Paquet 30g', prixFR: '13-15€', prixES: '3-5€', economie: '-70%' },
    { emoji: '👟', categorie: t('pjk.compare.vetements'), exemple: 'Baskets marque', prixFR: '80-120€', prixES: '35-60€', economie: '-50%' },
    { emoji: '💄', categorie: t('pjk.compare.parfums'), exemple: 'Parfum 100ml', prixFR: '60-90€', prixES: '25-45€', economie: '-45%' },
    { emoji: '🧀', categorie: t('pjk.compare.alimentation'), exemple: 'Jamón Ibérico 1kg', prixFR: '35-50€', prixES: '12-20€', economie: '-55%' },
    { emoji: '☕', categorie: t('pjk.compare.cafe'), exemple: 'Café moulu 500g', prixFR: '6-9€', prixES: '2-4€', economie: '-55%' },
    { emoji: '🔋', categorie: t('pjk.compare.electronique'), exemple: 'Accessoires tech', prixFR: '20-40€', prixES: '8-18€', economie: '-50%' },
    { emoji: '🧴', categorie: t('pjk.compare.sante'), exemple: 'Crème solaire', prixFR: '8-15€', prixES: '3-6€', economie: '-55%' },
  ]
    ...
    <section className="py-24 px-4 bg-brand-dark">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <span className="text-brand-red text-xs font-bold tracking-[0.3em] uppercase">{t('pjk.bonPlan')}</span>
        </motion.div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
          {[
            { n: t('pjk.stat.travel'), label: t('pjk.stat.travelLabel'), icon: '🚌' },
            { n: t('pjk.stat.savings'), label: t('pjk.stat.savingsLabel'), icon: '💰' },
            { n: t('pjk.stat.time'), label: t('pjk.stat.timeLabel'), icon: '🛍️' },
            { n: t('pjk.stat.duty'), label: t('pjk.stat.dutyLabel'), icon: '🇪🇺' },
          ].map((s, i) => (
            <motion.div
              key={s.label}
        ...
        <div className="mb-16">
          <h3 className="font-display text-3xl text-white mb-2 tracking-wide">{t('pjk.compare')}</h3>
          <p className="text-gray-500 text-sm mb-8">{t('pjk.compareSub')}</p>
              ...
              >
                ...
                <div className="flex items-center gap-3 flex-shrink-0">
                  <div className="text-center">
                    <div className="text-gray-500 text-[9px] uppercase font-bold mb-1">{t('pjk.compare.france')}</div>
                    <div className="text-gray-500 text-xs line-through">{p.prixFR}</div>
                  </div>
                  <div className="text-brand-red/30 text-lg">→</div>
                  <div className="text-center">
                    <div className="text-gray-400 text-[9px] uppercase font-bold mb-1">{t('pjk.compare.spain')}</div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-4 relative z-10">
              ...
              <h3 className="font-display text-3xl text-white">{t('pjk.laJonquera')}</h3>
            </div>
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-4 relative z-10">
              <span className="text-3xl">🛒</span>
              <h3 className="font-display text-3xl text-white">{t('pjk.mercado')}</h3>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed mb-6 relative z-10">
        ...
        >
          <p className="text-gray-400 mb-8 text-xl font-medium tracking-tight">{t('pjk.cta')}</p>
          <Link href="/sorties"
            ...
            {t('pjk.ctaButton')} <span className="text-xl">→</span>
          </Link>
        </motion.div>
